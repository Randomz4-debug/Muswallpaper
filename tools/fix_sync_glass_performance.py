...
l = LIVE.read_text()
# Remove the invalid nested data-class declaration left by an earlier patch.
l = l.replace('        private data class VisibleLyric(val line: LyricLine, val active: Boolean)\n\n', '')
