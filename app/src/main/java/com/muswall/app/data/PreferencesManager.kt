...
class PreferencesManager private constructor(context: Context) {
    ...
    companion object {
        ...
        fun getInstance(context: Context)=INSTANCE?:synchronized(this){INSTANCE?:PreferencesManager(context).also{INSTANCE=it}}
        const val MODE_MUSIC="music";const val MODE_STATIC="static"
        const val EFFECT_BLUR="blur";const val EFFECT_COVER="cover";const val EFFECT_CD="cd";const val EFFECT_SQUARE="square";const val EFFECT_COVER_COLOR="cover_color"
        const val BLUR_GAUSSIAN="gaussian";const val BLUR_SOLID="solid";const val BLUR_MOTION="motion";const val BLUR_GLASS="glass"
        const val BACKGROUND_ART="art";const val BACKGROUND_COLOR="color";const val BACKGROUND_GRADIENT="gradient";const val BACKGROUND_AUTO="auto"
        const val PHOTO_ALBUM="album";const val PHOTO_ART="art";const val PHOTO_DISPLAY_ICON="display_icon";const val PHOTO_NOTIFICATION="notification";const val PHOTO_CUSTOM="custom";const val PHOTO_ARTIST="artist";const val PHOTO_BACKGROUND="background"
